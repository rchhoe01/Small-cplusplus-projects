...
#pragma endregion
		...
		cli::array<int, 2> ^matrix = gcnew array<int, 2>(3,3);
		cli::array<int, 2> ^matrix1 = gcnew array<int, 2>(3, 3);
		List<int>^ matrixTemp = gcnew List<int>();
		cli::array<Label ^, 2> ^bInt = gcnew array<Label ^, 2>(3, 3);
		cli::array<Label ^, 2> ^cInt = gcnew array<Label ^, 2>(3, 3);
		...
		try
		{
			...
			while ((str = din->ReadLine()) != nullptr)
			{
				...
				if (b < 3) {
					...
					int c = b - 3;
					for (int a = 0; a < 3; a++) {
						matrix1[c,a ] = (System::Convert::ToInt32(words[a]));
					}
				}
			...
			for(int r = 0; r<row;r++ )
			{
				for (int c = 0; c < col; c++) {
					...
					bInt[r,c]->Size = System::Drawing::Size(90, 90);
					...
					bInt[r, c]->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 45));
					pos = pos + 100;
			...
			{
				for (int c = 0; c < col; c++) {
					cInt[r, c] = gcnew System::Windows::Forms::Label();
					this->Controls->Add(cInt[r, c]);
					cInt[r, c]->BackColor = System::Drawing::Color::White;
					cInt[r, c]->Size = System::Drawing::Size(45, 45);
					cInt[r, c]->Location = System::Drawing::Point(pos, posY);
					labelnum = matrix1[r, c];
					cInt[r, c]->Text = cInt[r, c]->Text + labelnum;
					cInt[r, c]->TextAlign = ContentAlignment::MiddleCenter;
					cInt[r, c]->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 13));
					pos = pos + 50;
					this->richTextBox1->Text = richTextBox1->Text + matrix[r, c] + " ";
				}
				this->richTextBox1->Text = richTextBox1->Text + "\r\n";
			...
			cInt[goalRow, goalCol]->BackColor = System::Drawing::Color::Red;
	...
	private: System::Void MyForm_KeyPress(System::Object^  sender, System::Windows::Forms::KeyPressEventArgs^  e) {
		...
		if (e->KeyChar == 'w')
			...
			if (pointRow > 0) {
				...
				bInt[pointRow - 1, pointCol]->BackColor = System::Drawing::Color::Red;

				pointValue = System::Convert::ToInt32(bInt[pointRow, pointCol]->Text);

				bInt[pointRow, pointCol]->Text = bInt[pointRow-1, pointCol]->Text;
				bInt[pointRow - 1, pointCol]->Text = pointValue.ToString();
				pointRow--;
			}
			else {
		...
		if (e->KeyChar == 'a')
		{
			...
			if (pointCol > 0) {
				bInt[pointRow, pointCol]->BackColor = System::Drawing::Color::White;
				bInt[pointRow, pointCol - 1]->BackColor = System::Drawing::Color::Red;

				pointValue = System::Convert::ToInt32(bInt[pointRow, pointCol]->Text);

				bInt[pointRow, pointCol]->Text = bInt[pointRow, pointCol - 1]->Text;
				bInt[pointRow, pointCol - 1]->Text = pointValue.ToString();
				pointCol--;
			}
...
private: System::Void label1_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	{
		for (int c = 0; c < col; c++) {
			bInt[r, c]->Text = matrix[r, c].ToString();
		}
	}
	bInt[pointRow,pointCol]->BackColor= System::Drawing::Color::White;
	pointRow = startRow;
